    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            8 בקתות היוקרה שלנו מספקות בסיס נעים, אבל את החופש והשלווה האמיתיים
            תמצאו בהרים שמסביב. לשוטט ביערות עבותים, לנשום את האוויר הצח ולראות
            את הכוכבים מנצנצים מלמעלה מהחום של מדורה או מהג'קוזי שלך.
          </p>
          <p>
